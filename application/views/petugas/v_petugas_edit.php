				...
				<?php foreach ($buku as $b) { ?>
					<form method="post" action="<?php echo base_url() . 'petugas/buku_update'; ?>">
						...
						<form method="post" action="<?php echo base_url() . 'petugas/buku_update'; ?>">
							...
							<div class="form-group">
								<label class="font-weight-bold" for="judul_asli">Judul Asli</label>
								<input type="text" class="form-control" name="judul_asli" placeholder="Masukkan judul asli" required="required" value="<?php echo $b->judul_asli; ?>">
							</div>
							<div class="form-group">
